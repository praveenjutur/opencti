...
export const caseRftKnowledgeGraphQuery = graphql`
  query CaseRftKnowledgeGraphQuery($id: String!) {
    caseRft(id: $id) {
      ...CaseRftKnowledgeGraph_case
    }
  }
`;

const caseRftKnowledgeGraphCheckObjectQuery = graphql`
  query CaseRftKnowledgeGraphCheckObjectQuery($id: String!) {
...
const caseRftKnowledgeGraphStixCoreObjectQuery = graphql`
  query CaseRftKnowledgeGraphStixCoreObjectQuery($id: String!) {
...
const caseRftKnowledgeGraphStixRelationshipQuery = graphql`
  query CaseRftKnowledgeGraphStixRelationshipQuery($id: String!) {
...
class CaseRftKnowledgeGraphComponent extends Component {
  ...
  async handleAddRelation(stixCoreRelationship) {
    ...
    commitMutation({
      mutation: caseRftKnowledgeGraphtMutationRelationAddMutation,
      variables: {
        id: this.props.caseData.id,
        input,
      },
  ...
  async handleDelete(stixCoreObject) {
    ...
    R.forEach((n) => {
      commitMutation({
        mutation: caseRftKnowledgeGraphMutationRelationDeleteMutation,
        variables: {
          id: this.props.caseData.id,
          toId: n.id,
          relationship_type: 'object',
  ...
  async handleDeleteSelected(deleteObject = false) {
    ...
    R.forEach((n) => {
      fetchQuery(caseRftKnowledgeGraphCheckObjectQuery, {
        id: n.id,
      })
        .toPromise()
        .then(async (data) => {
      ...
      fetchQuery(caseRftKnowledgeGraphCheckObjectQuery, {
        ...
        .then(async (data) => {
          if (
            ...
            commitMutation({
              mutation: caseRftKnowledgeGraphQueryStixObjectDeleteMutation,
              variables: {
                id: n.id,
              },
            });
  ...
  handleCloseEntityEdition(entityId) {
    setTimeout(() => {
      fetchQuery(caseRftKnowledgeGraphStixCoreObjectQuery, {
        id: entityId,
      })
        .toPromise()
        .then((data) => {
  ...
  handleCloseRelationEdition(relationId) {
    setTimeout(() => {
      fetchQuery(caseRftKnowledgeGraphStixRelationshipQuery, {
        id: relationId,
      })
        .toPromise()
        .then((data) => {
...
CaseRftKnowledgeGraphComponent.propTypes = {
...
const CaseRftKnowledgeGraph = createFragmentContainer(
  CaseRftKnowledgeGraphComponent,
  {
    caseData: graphql`
      fragment CaseRftKnowledgeGraph_case on CaseRft {
        id
        name
