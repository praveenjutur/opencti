...
class IncidentKnowledgeGraphComponent extends Component {
  ...
  async handleAddRelation(stixCoreRelationship) {
    ...
    commitMutation({
      mutation: incidentKnowledgeGraphtMutationRelationAddMutation,
      variables: {
        id: this.props.caseData.id,
        input,
      },
  ...
  async handleDelete(stixCoreObject) {
    ...
    R.forEach((n) => {
      commitMutation({
        mutation: incidentKnowledgeGraphMutationRelationDeleteMutation,
        variables: {
          id: this.props.caseData.id,
          toId: n.id,
          relationship_type: 'object',
...
IncidentKnowledgeGraphComponent.propTypes = {
...
const IncidentKnowledgeGraph = createFragmentContainer(
