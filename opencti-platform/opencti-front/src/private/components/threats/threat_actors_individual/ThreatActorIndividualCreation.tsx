...
import { ThreatActorIndividualCreationMutation, ThreatActorIndividualCreationMutation$variables } from './__generated__/ThreatActorIndividualCreationMutation.graphql';
